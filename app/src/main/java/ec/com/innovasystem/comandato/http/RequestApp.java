...
public class RequestApp extends JsonObjectRequest {
    ...
    public RequestApp(int metodo, String url, Response.Listener<JSONObject> listener, Response.ErrorListener errorListener) {
        super(metodo, url, listener, errorListener);
    }
